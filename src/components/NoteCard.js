...
const useStyles = makeStyles((theme) => ({
	...
	eventpage: {
		height: "30em",
		backgroundImage:
			"url('https://cdn.pixabay.com/photo/2014/03/22/17/00/the-background-292720_960_720.png')",
							...
							<Container className={classes.eventmaindiv}>
								<Box className={classes.eventheading}>
									...
									<Box className={classes.eventsidediv}>
										...
										<Button
											className={classes.eventbtncolor}
											variant="contained"
											color="secondary"
