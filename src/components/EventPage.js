    ...
    return (
        <div className={classes.page}>
            ...
            <Box className={classes.sidediv}>
                <Typography variant="h5">{date}<br/>{time}</Typography>
                <Typography variant="h4" align="center">{title}</Typography>   
                <Typography variant="h6" >{ispaid}</Typography>
            ...
            <Typography variant="p" align="left">{speaker}</Typography>
            </Container>
            <Container>
            <Typography variant="h6">Email For Enquiry: </Typography>
            <Typography variant="p" align="left">{email}</Typography>
            </Container>
            </Box>
            <Box className={classes.shortinfo}>
            <Container>
            <Typography variant="h6">Date And Time: </Typography>
            <Typography variant="p" align="left">{date}</Typography>
            </Container>
            <Container>
            <Typography variant="h6">Location</Typography>
            <Typography variant="h6">{isoffline}-Venue:</Typography>
