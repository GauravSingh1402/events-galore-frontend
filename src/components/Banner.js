        ...
        {event.map((obj, index) => {
            ...
            <div key={obj._id} style={{backgroundImage:`url(${obj.image})` ,backgroundRepeat: 'no-repeat', backgroundSize: '100% 100%'}} className={slideIndex === index + 1 ? "slide active-anim" : "slide"}>
                <div className="contest">
                    ...
                    <Typography style={{color: 'white'}} variant="h5" align="center">{obj.description}</Typography>
                    </div>
                    <div className="footercontent">
                        ...
                        <div className="content">
                            <Button className={classing.bannerbtn} variant="contained" 
						onClick={handleClickOpen}>Learn More...</Button>
